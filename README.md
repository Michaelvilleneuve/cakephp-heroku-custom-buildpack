...
This is not the official [Heroku buildpack](http://devcenter.heroku.com/articles/buildpacks) for PHP applications.
This is a custom buildpack to deploy Cakephp app in production width debug set to 0.

Except that, nothing has been changed.
